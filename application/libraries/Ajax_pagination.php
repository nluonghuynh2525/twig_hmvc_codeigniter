...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="pagination pagi_custom d-flex justify-content-center">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            $info = '<div class="d-flex justify-content-center" >Showing : ' . $this->total_rows. '</div>';
            return $info;
        }
