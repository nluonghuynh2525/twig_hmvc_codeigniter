                ...
                <form action="<?php echo current_url(); ?>" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <input type="text" name="username" value="<?php if(isset($info_detail['user_name'])) echo $info_detail['user_name']; ?>" id="username" readOnly="true" class="form-control">
                            <label for="title">Password</label>
                            <input type="password" name="password" value="" id="password" class="form-control">

                            <label for="title">Email</label>
                            <input type="text" name="email" value="<?php if(isset($info_detail['email'])) echo $info_detail['email']; ?>" id="password" class="form-control">

                            <label for="title">Full Name</label>
                            <input type="text" name="fullname" value="<?php if(isset($info_detail['full_name'])) echo $info_detail['full_name']; ?>" id="fullname" class="form-control">
                        </div>

                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <label for="title">Level</label>
                            <select class="form-control" name="level">
                                <option value="1" <?php if( isset($info_detail['level']) && $info_detail['level'] === "1") echo 'selected'; ?> >
                                Admin
                            </option>
                              <option value="2" <?php if( isset($info_detail['level']) && $info_detail['level'] === "2") echo 'selected'; ?> >Dev</option>
                            </select>
